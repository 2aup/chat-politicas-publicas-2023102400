...
<template>
  <div v-if="show" ref="menuRef" class="menu-container">
    <ul>
      ...
      <li>
        <svg class="icons" width="496px" height="496px" viewBox="0 0 496 496" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path class="fill-me"
            d="M11.6521 131.42C0.286052 138.24 -3.39938 152.982 3.42014 164.348C10.2397 175.714 24.982 179.399 36.3478 172.58L11.6521 131.42ZM184 56L198.4 36.8C190.595 30.9453 180.019 30.3997 171.651 35.4202L184 56ZM312 152L297.6 171.2C306.355 177.767 318.445 177.578 326.992 170.741L312 152ZM486.992 42.7408C497.344 34.4605 499.021 19.3578 490.742 9.00735C482.461 -1.34305 467.357 -3.02112 457.008 5.2592L486.992 42.7408ZM416 472C416 485.254 426.746 496 440 496C453.254 496 464 485.254 464 472H416ZM464 216C464 202.746 453.254 192 440 192C426.746 192 416 202.746 416 216H464ZM160 472C160 485.254 170.746 496 184 496C197.254 496 208 485.254 208 472H160ZM208 216C208 202.746 197.254 192 184 192C170.746 192 160 202.746 160 216H208ZM288 472C288 485.254 298.746 496 312 496C325.254 496 336 485.254 336 472H288ZM336 312C336 298.746 325.254 288 312 288C298.746 288 288 298.746 288 312H336ZM32 472C32 485.254 42.7452 496 56 496C69.2547 496 80 485.254 80 472H32ZM80 312C80 298.746 69.2547 288 56 288C42.7452 288 32 298.746 32 312H80ZM36.3478 172.58L196.349 76.5798L171.651 35.4202L11.6521 131.42L36.3478 172.58ZM169.6 75.2L297.6 171.2L326.4 132.8L198.4 36.8L169.6 75.2ZM326.992 170.741L486.992 42.7408L457.008 5.2592L297.008 133.259L326.992 170.741ZM464 472V216H416V472H464ZM208 472V216H160V472H208ZM336 472V312H288V472H336ZM80 472V312H32V472H80Z"
            fill="black" />
        </svg>
        <div>
          <a href="https://classificadorficanafacul.com.br" target="_blank">{{ t("home.classifier") }}</a>
          <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path class="fill-me"
              d="M0.401574 6.64002C0.206311 6.83528 0.206311 7.15186 0.401574 7.34712C0.596836 7.54238 0.913418 7.54238 1.10868 7.34712L0.755127 6.99357L0.401574 6.64002ZM7.24875 0.999949C7.24875 0.723807 7.02489 0.499949 6.74875 0.499949L2.24875 0.499949C1.9726 0.499949 1.74875 0.723807 1.74875 0.999949C1.74875 1.27609 1.9726 1.49995 2.24875 1.49995H6.24875L6.24875 5.49995C6.24875 5.77609 6.4726 5.99995 6.74875 5.99995C7.02489 5.99995 7.24875 5.77609 7.24875 5.49995L7.24875 0.999949ZM0.755127 6.99357L1.10868 7.34712L7.1023 1.3535L6.74875 0.999949L6.39519 0.646396L0.401574 6.64002L0.755127 6.99357Z"
              fill="#222222" />
          </svg>
        </div>
      </li>
